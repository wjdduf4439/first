...
public class TemplateOneVO extends VOobject {
	...
	private List<MultipartFile> b_filename;//파일 폼의 파일 자료
	
	private String delValue;
	private String[] delArray;	//뷰에서 삭제할 파일들 목록
	...
	public String[] getDelArray() {
		return delArray;
	}

	public void setDelArray(String[] delArray) {
